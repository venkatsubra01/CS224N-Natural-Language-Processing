...
if args.function == 'pretrain':
    ...
    finetune_dataset = dataset.NameDataset(pretrain_dataset, finetune_text) #pass in teh pretrain dataset to have the ids matching up to vocab words
        # finetune_dataset splits each line into a new data point
